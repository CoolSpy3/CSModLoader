...
public class ServerAddress
{
    ...
    private static ServerAddress lookupSrv(String p_241677_0_)
    {
        try
        {
            ...
            Attributes attributes = dircontext.getAttributes("_minecraft._tcp." + p_241677_0_,
                    new String[] {"SRV"});
            Attribute attribute = attributes.get("srv");
            if (attribute != null)
            {
                String[] astring = attribute.get().toString().split(" ", 4);
                return new ServerAddress(astring[3], parseInt(astring[2], 25565));
            }
        }
        catch (Throwable throwable)
        {}

        return new ServerAddress(p_241677_0_, 25565);
    }
